...
def get_args():
    ...
    parser.add_argument(
        "--kl_loss_weight", type=int, default=0
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="Toggle to use lora in training",
    )
    parser.add_argument("--r", type=int, default=16, help="Lora hidden dimensions")
    parser.add_argument(
        "--lora_alpha", type=int, default=32, help="Alpha param, see Lora doc."
    )
    parser.add_argument(
        "--lora_dropout",
        type=float,
        default=0.1,
        help="Dropout in the learned extensions",
    )
    ...
    parser.add_argument(
        "--sampling_method",
        type=str,
        choices=["uniform", "inverse-prop", "minority"],
        default="minority",
    )
